...
var (
	...
	aEnableCeph        = flag.Bool("enable-ceph", getENVDefault("ENABLE_CEPH", "false"), "enable ceph integration")
	...
	aEnableSafeRoute   = flag.Bool("enable-safe-route", getENVDefault("ENABLE_SAFE_ROUTE", "false"), "enable safe route")
	aSafeKey           = flag.String("safe-key", getENVDefault("SAFE_KEY", ""), "secret key to hash URI that is used with enable-safe-route")
